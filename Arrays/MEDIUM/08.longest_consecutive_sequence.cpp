...
/*
    ...
    2. iterate the set and check:
        if element is the starting point of the increasing sequence (means there is no nums[i-1])
            then define two variables, currSeq and starting point of while loop j = current iteration
            run a while loop until the last consecutive element
        save the max value in maxCons from maxCons and currSeq
*/
